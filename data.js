...
const GAME_DATA = {
  ...
  rosters: {
	...
	"FC Prazins Corvite": [
		{n:"Fábio Freitas", p:"GR"},
		{n:"Pedro Pereira", p:"GR"},
		{n:"Gonçalo Ferreira", p:"DC"},
		{n:"Leonel Batista", p:"DC"},
		{n:"João Mendes", p:"LD"},
		{n:"Hélder Ribeiro", p:"DC"},
		{n:"Leandro Leandro", p:"LE"},
		{n:"Twix Twix", p:"LE"},
		{n:"Luís Alves", p:"LD"},
		{n:"Gouveia Gouveia", p:"MC"},
		{n:"Lucas Lucas", p:"MC"},
		{n:"Luís Fernandes", p:"MDC"},
		{n:"Josué Pereira", p:"MDC"},
		{n:"Ricardo Pereira", p:"MC"},
		{n:"Miguel Jordão", p:"MC"},
		{n:"Trina Trina", p:"ED"},
		{n:"Samuel Costa", p:"EE"},
		{n:"César Freitas", p:"PL"},
		{n:"José Gabriel", p:"PL"},
		{n:"Meira Meira", p:"ED"}
	],
    "GD Gemeos":[
