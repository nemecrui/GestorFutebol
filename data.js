...
const GAME_DATA = {
  ...
  novidades: [
    ...
    { data:"2026-09-18", texto:"👔 Equipa técnica: todas as equipas passam a ter treinador e adjuntos. Vês a tua equipa técnica no separador «Tática» e o treinador adversário na antevisão do jogo. Quem quiser pode definir os nomes reais no data.js (secção «treinadores»)." },
